...
let handler = async (m, { conn }) => {
  ...
  try {
    ...
    let infobt = `
🔰 *I'm 𝚪𝐔𝐒𝚮-𝚳𝘿.* *A WhatsApp Advanced bot with Rich Exciting features* *Created By Rush*. 🔰
...
`;
    ...
    conn.sendMessage(m.chat, { video: { url: "https://telegra.ph/file/d3a5d027f4b3cb85aa281.mp4" }, caption: infobt, gifPlayback: true }, { quoted: m });
  } catch (error) {
    console.error(error);
